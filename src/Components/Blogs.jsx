                    ...
                    return <div key={post.id} className=" ">
                        ...
                        <div className="flex flex-wrap gap-x-2 items-center">
                            {post.tags.map((tag, index) => {
                                //map me important hota hai ki key pass kare lekin agar nhi hai to index ka use karenge 
                                //when we use curly braces return is required () not need to add return
